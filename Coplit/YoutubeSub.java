...
public class YoutubeSub {
    ...
    static final String PWD = "0000";
    /**
     * @static 은 별도의 객체 생성 없이 바로 사용이 가능 합니다.
     * 본 프로그램의 금칙어 리스트와 대체어 리스트를 배열로 정의합니다.
     */
    static final String[] FARR = {"킹", "시발", "꺼져", "미친"};
    static final String[] TARR = {"열", "사랑", "저리가", "희망"};

    public static void main(String[] args) {
        // 사용자의 입력을 받기위한 Scanner s 객체 생성
        Scanner s = new Scanner(System.in);
        String id, pwd, input = null;
        //TODO:
        /**
        ...
        for (int i = 0; i < FARR.length; i++) {
            input = input.replaceAll(FARR[i], TARR[i]);
        }
